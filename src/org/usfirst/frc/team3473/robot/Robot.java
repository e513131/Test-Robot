...
import org.usfirst.frc.team3473.robot.commands.IntakeBall;
import org.usfirst.frc.team3473.robot.commands.MoveForward;
import org.usfirst.frc.team3473.robot.commands.ShootBall;
...
public class Robot extends TimedRobot {
	...
	public void autonomousInit() {
		m_autonomousCommand = m_chooser.getSelected();
			...
			auton.addSequential(new MoveForward(0.5, 2000));
			auton.addSequential(new TurnAngle(0.5,80));
			//auton.addParallel(command); for making this go at the same time as the top one
			auton.start();
	}
